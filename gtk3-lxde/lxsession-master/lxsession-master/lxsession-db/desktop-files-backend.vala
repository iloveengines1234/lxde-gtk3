...
namespace Lxsession
{
    ...
    {
        // Using GLib.List<string> requires careful pointer handling in Vala; 
        // standard practice in modern Vala ports is to use GLib.List<unowned string> or generic arrays.
        // Keeping GLib.List for compatibility with your frontend, but initializing correctly.
        public GLib.List<string> webbrowser_installed = new GLib.List<string> ();
        public GLib.List<string> webbrowser_available = new GLib.List<string> ();
        public string webbrowser_installed_blacklist;

        public GLib.List<string> email_installed = new GLib.List<string> ();
        public GLib.List<string> email_available = new GLib.List<string> ();
        public string email_installed_blacklist;

        public GLib.List<string> file_manager_installed = new GLib.List<string> ();
        public GLib.List<string> file_manager_available = new GLib.List<string> ();
        public string file_manager_blacklist;

        public string screensaver_blacklist;
        public GLib.List<string> screensaver_installed = new GLib.List<string> ();
        public GLib.List<string> screensaver_available = new GLib.List<string> ();

        public string composite_manager_blacklist;
        public GLib.List<string> composite_manager_installed = new GLib.List<string> ();
        public GLib.List<string> composite_manager_available = new GLib.List<string> ();

        public string desktop_manager_blacklist;
        public GLib.List<string> desktop_manager_installed = new GLib.List<string> ();
        public GLib.List<string> desktop_manager_available = new GLib.List<string> ();

        public string power_manager_blacklist;
        public GLib.List<string> power_manager_installed = new GLib.List<string> ();
        public GLib.List<string> power_manager_available = new GLib.List<string> ();

        public string polkit_blacklist;
        public GLib.List<string> polkit_installed = new GLib.List<string> ();
        public GLib.List<string> polkit_available = new GLib.List<string> ();

        public string im_blacklist;
        public GLib.List<string> im_installed = new GLib.List<string> ();
        public GLib.List<string> im_available = new GLib.List<string> ();

        public string widget_blacklist;
        public GLib.List<string> widget_installed = new GLib.List<string> ();
        public GLib.List<string> widget_available = new GLib.List<string> ();

        public string terminal_manager_blacklist;
        public GLib.List<string> terminal_manager_installed = new GLib.List<string> ();
        public GLib.List<string> terminal_manager_available = new GLib.List<string> ();

        public string audio_blacklist;
        public GLib.List<string> audio_installed = new GLib.List<string> ();
        public GLib.List<string> audio_available = new GLib.List<string> ();

        public string video_blacklist;
        public GLib.List<string> video_installed = new GLib.List<string> ();
        public GLib.List<string> video_available = new GLib.List<string> ();

        public string audio_video_blacklist;
        public string viewer_blacklist;

        public GLib.List<string> image_display_installed = new GLib.List<string> ();
        public GLib.List<string> pdf_reader_installed = new GLib.List<string> ();

        public GLib.List<string> image_display_available = new GLib.List<string> ();
        public GLib.List<string> pdf_reader_available = new GLib.List<string> ();

        public string text_editor_blacklist;
        public GLib.List<string> text_editor_installed = new GLib.List<string> ();
        public GLib.List<string> text_editor_available = new GLib.List<string> ();

        public string archive_blacklist;
        public GLib.List<string> archive_installed = new GLib.List<string> ();
        public GLib.List<string> archive_available = new GLib.List<string> ();

        public string spreadsheet_blacklist;
        public GLib.List<string> spreadsheet_installed = new GLib.List<string> ();
        public GLib.List<string> spreadsheet_available = new GLib.List<string> ();

        public string bittorent_blacklist;
        public GLib.List<string> bittorent_installed = new GLib.List<string> ();
        public GLib.List<string> bittorent_available = new GLib.List<string> ();

        public string document_blacklist;
        public GLib.List<string> document_installed = new GLib.List<string> ();
        public GLib.List<string> document_available = new GLib.List<string> ();

        public string burn_blacklist;
        public GLib.List<string> burn_installed = new GLib.List<string> ();
        public GLib.List<string> burn_available = new GLib.List<string> ();

        public string tasks_blacklist;
        public GLib.List<string> tasks_installed = new GLib.List<string> ();
        public GLib.List<string> tasks_available = new GLib.List<string> ();
        ...
        private string[] mime_folders_installed = {"/usr/share/applications"};
        private string[] mime_folders_available = {"/usr/share/app-install/desktop"};

        private string mode;
        private KeyFile kf;
        private string config_path;

        // Global DB references need to be declared or fetched. Assuming External interaction.
        // Provided placeholder reference if global_db is managed outside.
        private dynamic global_db; 

        public DBDefaultApps(string? mode_argument)
        {
            this.global_db = this; // Fallback mapping in case it prints to self
            init();
        ...
        public void on_finish_scanning_available()
        {
            ...
            if (this.mode == "display")
            {
                this.print_values_available();
            }
            else if (this.mode == "write")
            {
                this.save_values_available();
            }
        ...
        {
            string[] default_install = mime_folders_installed;
            ...
            if (default_install != null)
            {
                foreach (string folder in default_install)
                {
                    ...
                    list_desktop_files.begin(folder, "installed", (obj, res) => {});
                }
            }
            else
            {
        ...
        {
            string[] default_available = mime_folders_available;
            ...
            if (default_available != null)
            {
                foreach (string folder in default_available)
                {
                    ...
                    {
                        message("Scanning folder: %s", folder);
                        list_desktop_files.begin(folder, "available", (obj, res) => {});
                    }
                    else
                    {
                ...
                while (true)
                {
                    ...
                    foreach (var info in files)
                    {
                        try
                        {
                            ...
                            local_kf.load_from_file(desktop_path, KeyFileFlags.NONE);

                            if (local_kf.has_key("Desktop Entry", "Categories"))
                            {
                                find_list(local_kf, desktop_path, info.get_name(), mode);
                            }
                        }
                        catch (KeyFileError err)
                        {
        ...
        public string create_entry(KeyFile kf, string desktop_path)
        {
            ...
            return "%s,%s,%s,%s,%s".printf(tmp_name, create_exec_string(kf), tmp_icon, desktop_path, tmp_install_package);
        }
        ...
        public string create_exec_string(KeyFile kf)
        {
            ...
            string[] tmp_value = tmp_string.split(" ");
            return tmp_value[0] ?? "";
        }
                ...
                if (categories != null)
                {
                    if ("WebBrowser" in categories)
                    {
                        if (!(name in webbrowser_installed_blacklist))
                        {
                            ...
                            if (mode == "installed") webbrowser_installed.append(new_entry);
                            else if (mode == "available") webbrowser_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Email" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") email_installed.append(new_entry);
                            else if (mode == "available") email_available.append(new_entry);
                        }
                    }
                    ...
                    if ("FileManager" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") file_manager_installed.append(new_entry);
                            else if (mode == "available") file_manager_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Screensaver" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") screensaver_installed.append(new_entry);
                            else if (mode == "available") screensaver_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Composite" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") composite_manager_installed.append(new_entry);
                            else if (mode == "available") composite_manager_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Desktop" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") desktop_manager_installed.append(new_entry);
                            else if (mode == "available") desktop_manager_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Power" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") power_manager_installed.append(new_entry);
                            else if (mode == "available") power_manager_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Polkit" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") polkit_installed.append(new_entry);
                            else if (mode == "available") polkit_available.append(new_entry);
                        }
                    }
                    if ("InstantMessaging" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") im_installed.append(new_entry);
                            else if (mode == "available") im_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Widget" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") widget_installed.append(new_entry);
                            else if (mode == "available") widget_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Terminal" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") terminal_manager_installed.append(new_entry);
                            else if (mode == "available") terminal_manager_available.append(new_entry);
                        }
                    }
                    ...
                    else if ("Audio" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") audio_installed.append(new_entry);
                            else if (mode == "available") audio_available.append(new_entry);
                        }
                    }
                    else if ("Video" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") video_installed.append(new_entry);
                            else if (mode == "available") video_available.append(new_entry);
                        }
                    }
                    ...
                    if ("TextEditor" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") text_editor_installed.append(new_entry);
                            else if (mode == "available") text_editor_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Archiving" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") archive_installed.append(new_entry);
                            else if (mode == "available") archive_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Spreadsheet" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") spreadsheet_installed.append(new_entry);
                            else if (mode == "available") spreadsheet_available.append(new_entry);
                        }
                    }
                    ...
                    if ("P2P" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") bittorent_installed.append(new_entry);
                            else if (mode == "available") bittorent_available.append(new_entry);
                        }
                    }
                    ...
                    if ("WordProcessor" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") document_installed.append(new_entry);
                            else if (mode == "available") document_available.append(new_entry);
                        }
                    }
                    ...
                    if ("DiscBurning" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") burn_installed.append(new_entry);
                            else if (mode == "available") burn_available.append(new_entry);
                        }
                    }
                    ...
                    if ("Monitor" in categories)
                    {
                        ...
                        {
                            string new_entry = create_entry(kf, desktop_path);
                            if (mode == "installed") tasks_installed.append(new_entry);
                            else if (mode == "available") tasks_available.append(new_entry);
                        }
                    }
                }
            }
        ...
        public void keyfile_set_list_string(KeyFile kf, string categorie, string key1, GLib.List<string> list)
        {
            string[] tmp_array = new string[0];

...
static void fm_app_config_init(FmAppConfig *cfg)
{
    ...
    cfg->desktop_section.desktop_fg.red = cfg->desktop_section.desktop_fg.green = cfg->desktop_section.desktop_fg.blue = 1.0;
...
void fm_app_config_load_desktop_config(GKeyFile *kf, const char *group, FmDesktopConfig *cfg)
{
    ...
    cfg->desktop_fg.red = cfg->desktop_fg.green = cfg->desktop_fg.blue = 1.0;
...
void fm_app_config_save_desktop_config(GString *buf, const char *group, FmDesktopConfig *cfg)
{
    ...
    {
        int r, g, b;
        r = (int)(cfg->desktop_bg.red * 255.0 + 0.5);
        g = (int)(cfg->desktop_bg.green * 255.0 + 0.5);
        b = (int)(cfg->desktop_bg.blue * 255.0 + 0.5);
        g_string_append_printf(buf, "desktop_bg=#%02x%02x%02x\n", r, g, b);
        r = (int)(cfg->desktop_fg.red * 255.0 + 0.5);
        g = (int)(cfg->desktop_fg.green * 255.0 + 0.5);
        b = (int)(cfg->desktop_fg.blue * 255.0 + 0.5);
        g_string_append_printf(buf, "desktop_fg=#%02x%02x%02x\n", r, g, b);
        r = (int)(cfg->desktop_shadow.red * 255.0 + 0.5);
        g = (int)(cfg->desktop_shadow.green * 255.0 + 0.5);
        b = (int)(cfg->desktop_shadow.blue * 255.0 + 0.5);

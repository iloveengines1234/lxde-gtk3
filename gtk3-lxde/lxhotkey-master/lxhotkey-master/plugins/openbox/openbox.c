...
/* MODERN FIX: Enable options comparison layout processing before pulling core parameters */
#define WANT_OPTIONS_EQUAL 1
...
/* HARDENED FIX: Repaired all legacy "lkxeys_" typos across macro definitions and function spaces */
#define free_options(acts) g_list_free_full(acts, (GDestroyNotify)lxhotkey_attr_free)

static void lxhotkey_attr_free(LXHotkeyAttr *data)
{
...
static void lxhotkey_action_free(LXHotkeyGlobal *data)
{
    if G_UNLIKELY(!data) return;
...
static void lxhotkey_app_free(LXHotkeyApp *data)
{
    if G_UNLIKELY(!data) return;
    g_free(data->exec);
...
static gchar *obkey_to_key(const gchar *obkey)
{
    ...
    while (*obkey) {
        if (obkey[1] == '-') {
            switch(obkey[0]) {
            case 'S': g_string_append(str, "<Shift>"); break;
            case 'C': g_string_append(str, "<Control>"); break;
            case 'A': g_string_append(str, "<Alt>"); break;
            case 'W': g_string_append(str, "<Super>"); break;
            case 'M': g_string_append(str, "<Meta>"); break;
            case 'H': g_string_append(str, "<Hyper>"); break;
            default: goto _add_rest;
            }
        } else {
_add_rest:
            break;
    ...
    while (*key) {
        if (in_lt) {
            ...
            if (strncmp(key, "Shift", 5) == 0) {
                ...
                key += 5;
            } else if (strncmp(key, "Contr", 5) == 0 || strncmp(key, "Ctr", 3) == 0) {
...
static gboolean restart_openbox(GError **error)
{
    ...
    if (!dpy) {
        g_set_error_literal(error, LXKEYS_OB_ERROR, LXKEYS_FILE_ERROR,
                            _("Failed to open X11 display context."));
        return FALSE;
    }
    XEvent ce;
    gboolean ret = TRUE;
    ...
    ce.xclient.data.l[0] = 1; /* Reconfigure signal */
    ...
    if (ce.xclient.message_type == None ||
        ...
        g_set_error_literal(error, LXKEYS_OB_ERROR, LXKEYS_FILE_ERROR,
                            _("Failed to reconfigure Openbox window manager."));
        ret = FALSE;
    }
    XCloseDisplay(dpy);
    return ret;
...
#define TO_BE_PREVIOUS TO_BE_CONVERTED(1)
#define BOOLEAN_VALUES TO_BE_CONVERTED(2)

static char * values_enabled[] = { N_("yes"), N_("no"), NULL };

static LXHotkeyAttr options_startupnotify[] = {
    { N_("enabled"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("wmclass"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("name"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("icon"), NULL, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static LXHotkeyAttr options_Execute[] = {
    { N_("command"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("prompt"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("startupnotify"), NULL, TO_BE_CONVERTED(options_startupnotify), NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static char * values_x[] = { "#", "%", N_("center"), NULL };
static char * values_monitor[] = { N_("default"), N_("primary"), N_("mouse"), N_("active"), N_("all"), "#", NULL };

static LXHotkeyAttr options_position[] = {
    { "x", TO_BE_CONVERTED(values_x), NULL, NULL, FALSE, FALSE },
    { "y", TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { N_("monitor"), TO_BE_CONVERTED(values_monitor), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static LXHotkeyAttr options_ShowMenu[] = {
    { N_("menu"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("position"), NULL, TO_BE_CONVERTED(options_position), NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_NextWindow[] = {
    { N_("dialog"), TO_BE_CONVERTED(values_dialog), NULL, NULL, FALSE, FALSE },
    { N_("bar"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("raise"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("allDesktops"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("panels"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("desktop"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("linear"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("interactive"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("finalactions"), NULL, NULL, NULL, TRUE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static char * values_direction[] = { N_("north"), N_("northeast"), N_("east"), N_("southeast"), N_("south"), N_("southwest"), N_("west"), N_("northwest"), NULL };

static LXHotkeyAttr options_DirectionalCycleWindows[] = {
    { N_("direction"), TO_BE_CONVERTED(values_direction), NULL, NULL, FALSE, FALSE },
    { N_("dialog"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("bar"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("raise"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("panels"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("desktops"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("finalactions"), NULL, NULL, NULL, TRUE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static char * values_to[] = { "#", N_("current"), N_("next"), N_("previous"), N_("last"), N_("north"), N_("up"), N_("south"), N_("down"), N_("west"), N_("left"), N_("east"), N_("right"), NULL };

static LXHotkeyAttr options_GoToDesktop[] = {
    { N_("to"), TO_BE_CONVERTED(values_to), NULL, NULL, FALSE, FALSE },
    { N_("wrap"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_AddDesktop[] = {
    { N_("where"), TO_BE_CONVERTED(values_where), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static LXHotkeyAttr options_ToggleShowDesktop[] = {
    { N_("strict"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_Exit[] = {
    { N_("prompt"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_ToggleMaximize[] = {
    { N_("direction"), TO_BE_CONVERTED(values_directionM), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static char * values_toS[] = { "#", N_("current"), N_("next"), N_("previous"), N_("last"), N_("north"), N_("up"), N_("south"), N_("down"), N_("west"), N_("left"), N_("east"), N_("right"), NULL };

static LXHotkeyAttr options_SendToDesktop[] = {
    { N_("to"), TO_BE_CONVERTED(values_toS), NULL, NULL, FALSE, FALSE },
    { N_("wrap"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { N_("follow"), BOOLEAN_VALUES, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static char * values_edge[] = { N_("top"), N_("left"), N_("right"), N_("bottom"), N_("topleft"), N_("topright"), N_("bottomleft"), N_("bottomright"), NULL };

static LXHotkeyAttr options_Resize[] = {
    { N_("edge"), TO_BE_CONVERTED(values_edge), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_MoveResizeTo[] = {
    { "x", TO_BE_CONVERTED(values_xM), NULL, NULL, FALSE, FALSE },
    { "y", TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { N_("width"), TO_BE_CONVERTED(values_width), NULL, NULL, FALSE, FALSE },
    { N_("height"), TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { N_("monitor"), TO_BE_CONVERTED(values_monitorM), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_MoveRelative[] = {
    { "x", TO_BE_CONVERTED(values_xR), NULL, NULL, FALSE, FALSE },
    { "y", TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_ResizeRelative[] = {
    { N_("left"), TO_BE_CONVERTED(values_xRR), NULL, NULL, FALSE, FALSE },
    { N_("right"), TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { N_("top"), TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { N_("bottom"), TO_BE_PREVIOUS, NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_MoveToEdge[] = {
    { N_("direction"), TO_BE_CONVERTED(values_directionE), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static LXHotkeyAttr options_SendToLayer[] = {
    { N_("layer"), TO_BE_CONVERTED(values_layer), NULL, NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};

static LXHotkeyAttr list_actions[] = {
    { N_("Execute"), NULL, TO_BE_CONVERTED(options_Execute), NULL, FALSE, FALSE },
    { N_("ShowMenu"), NULL, TO_BE_CONVERTED(options_ShowMenu), NULL, FALSE, FALSE },
    { N_("NextWindow"), NULL, TO_BE_CONVERTED(options_NextWindow), NULL, FALSE, FALSE },
    { N_("PreviousWindow"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("DirectionalCycleWindows"), NULL, TO_BE_CONVERTED(options_DirectionalCycleWindows), NULL, FALSE, FALSE },
    { N_("DirectionalTargetWindow"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("GoToDesktop"), NULL, TO_BE_CONVERTED(options_GoToDesktop), NULL, FALSE, FALSE },
    { N_("AddDesktop"), NULL, TO_BE_CONVERTED(options_AddDesktop), NULL, FALSE, FALSE },
    { N_("RemoveDesktop"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("ToggleShowDesktop"), NULL, TO_BE_CONVERTED(options_ToggleShowDesktop), NULL, FALSE, FALSE },
    { N_("ToggleDockAutohide"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Reconfigure"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Restart"), NULL, TO_BE_CONVERTED(options_Restart), NULL, FALSE, FALSE },
    { N_("Exit"), NULL, TO_BE_CONVERTED(options_Exit), NULL, FALSE, FALSE },
    { N_("Focus"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Raise"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Lower"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("RaiseLower"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Unfocus"), NULL, NULL, NULL, FALSE, FALSE },
    { FocusToBottom, NULL, NULL, NULL, FALSE, FALSE },
    { N_("Iconify"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Close"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("ToggleShade"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Shade"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Unshade"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("ToggleOmnipresent"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("ToggleMaximize"), NULL, TO_BE_CONVERTED(options_ToggleMaximize), NULL, FALSE, FALSE },
    { N_("Maximize"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("Unmaximize"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("ToggleFullscreen"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("ToggleDecorations"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Decorate"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Undecorate"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("SendToDesktop"), NULL, TO_BE_CONVERTED(options_SendToDesktop), NULL, FALSE, FALSE },
    { N_("Move"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("Resize"), NULL, TO_BE_CONVERTED(options_Resize), NULL, FALSE, FALSE },
    { N_("MoveResizeTo"), NULL, TO_BE_CONVERTED(options_MoveResizeTo), NULL, FALSE, FALSE },
    { N_("MoveRelative"), NULL, TO_BE_CONVERTED(options_MoveRelative), NULL, FALSE, FALSE },
    { N_("ResizeRelative"), NULL, TO_BE_CONVERTED(options_ResizeRelative), NULL, FALSE, FALSE },
    { N_("MoveToEdge"), NULL, TO_BE_CONVERTED(options_MoveToEdge), NULL, FALSE, FALSE },
    { N_("GrowToEdge"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("ShrinkToEdge"), NULL, TO_BE_PREVIOUS, NULL, FALSE, FALSE },
    { N_("GrowToFill"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("ToggleAlwaysOnTop"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("ToggleAlwaysOnBottom"), NULL, NULL, NULL, FALSE, FALSE },
    { N_("SendToLayer"), NULL, TO_BE_CONVERTED(options_SendToLayer), NULL, FALSE, FALSE },
    { NULL, NULL, NULL, NULL, FALSE, FALSE }
};
...
static FmXmlFileTag ObXmlFile_keyboard;
static FmXmlFileTag ObXmlFile_keybind;
static FmXmlFileTag ObXmlFile_action;
static FmXmlFileTag ObXmlFile_command;
static FmXmlFileTag ObXmlFile_execute;
                                    ...
                                    GError **error, gpointer user_data)
{
    ...
    if (children && !children->next && fm_xml_file_item_get_tag(children->data) == ObXmlFile_action) {
        if (strcmp(action->name, "Execute") == 0) {
            FmXmlFileItem *exec = fm_xml_file_item_find_child(children->data, ObXmlFile_command);
            if (!exec)
    ...
    if (app) {
        ...
        for (l = cfg->actions; l; l = l->next) {
            if (options_equal((act = l->data)->actions, actions) && act->accel2 == NULL)
                break;
        }
        if (l == NULL) {
...
static GList *resolve_item(GList **stack, GList *children, GList **value, GError **error)
{
    ...
    for (child = children; child; child = child->next) {
        item = child->data;
        if (fm_xml_file_item_get_tag(item) == FM_XML_FILE_TEXT) {
            *value = g_list_prepend(*value, g_strdup(fm_xml_file_item_get_data(item, NULL)));
            continue;
        }
        if (fm_xml_file_item_get_tag(item) == ObXmlFile_action) {
            g_set_error_literal(error, LXKEYS_OB_ERROR, LXKEYS_PARSE_ERROR,
                                   ...
                                   GError **error, gpointer user_data)
{
    ...
    } else if ((oblist = cfg->stack->data)->parent != parent) {
        g_set_error_literal(error, LXKEYS_OB_ERROR, LXKEYS_PARSE_ERROR,
                            _("Internal error."));
        lxhotkey_attr_free(data);
        return FALSE;
...
static void obcfg_free(gpointer config)
{
    ...
    if G_UNLIKELY(!cfg) return;

    g_free(cfg->path);
    if (cfg->xml) g_object_unref(cfg->xml);
    g_list_free_full(cfg->actions, (GDestroyNotify)lxhotkey_action_free);
    g_list_free_full(cfg->execs, (GDestroyNotify)lxhotkey_app_free);
    clear_stack(cfg);
...
static gpointer obcfg_load(gpointer config, GError **error)
{
    ...
    if (config) {
        ...
        ObXmlFile_keyboard = fm_xml_file_set_handler(cfg->xml, "keyboard", &tag_handler_keyboard, FALSE, NULL);
        ObXmlFile_keybind = fm_xml_file_set_handler(cfg->xml, "keybind", &tag_handler_keybind, FALSE, NULL);
        ObXmlFile_action = fm_xml_file_set_handler(cfg->xml, "action", &tag_handler_action, FALSE, NULL);
        ObXmlFile_command = fm_xml_file_set_handler(cfg->xml, "command", &tag_handler_command, FALSE, NULL);
        ObXmlFile_execute = fm_xml_file_set_handler(cfg->xml, "execute", &tag_handler_command, FALSE, NULL);
        
        session = g_getenv("DESKTOP_SESSION");
        if (session == NULL) session = g_getenv("GDMSESSION");
        if (session == NULL) session = g_getenv("XDG_CURRENT_DESKTOP");
        
        if (g_strcmp0(session, "Lubuntu") == 0)
            cfg->path = g_build_filename(g_get_user_config_dir(), "openbox", "lubuntu-rc.xml", NULL);
        else if (g_strcmp0(session, "LXDE") == 0)
            cfg->path = g_build_filename(g_get_user_config_dir(), "openbox", "lxde-rc.xml", NULL);
        else if (g_strcmp0(session, "LXDE-pi") == 0)
            cfg->path = g_build_filename(g_get_user_config_dir(), "openbox", "lxde-pi-rc.xml", NULL);
        else
            cfg->path = g_build_filename(g_get_user_config_dir(), "openbox", "rc.xml", NULL);
    }
...
static FmXmlFileItem *make_new_xml_item(ObXmlFile *cfg, LXHotkeyAttr *opt, GList **opts, gboolean is_action)
{
    ...
    if (is_action) {
        ...
        for (l = cfg->added_tags; l; l = l->next) {
            if (g_strcmp0(fm_xml_file_get_tag_name(cfg->xml, GPOINTER_TO_UINT(l->data)), opt->name) == 0)
                break;
        }
        if (l == NULL) {
    ...
    for (l = opt->subopts; l; l = l->next) {
        sub = make_new_xml_item(cfg, l->data, act ? &act->subopts : NULL, opt->has_actions);
        fm_xml_file_item_append_child(item, sub);
    }
    return item;
}

static FmXmlFileItem *make_new_xml_binding(ObXmlFile *cfg, GList *actions, const gchar *accel, GList **opts, const gchar *exec)
{
...
_accel1_bound:
                g_set_error(error, LXKEYS_OB_ERROR, LXKEYS_FILE_ERROR,
                            _("Hotkey '%s' is already bound to an action."), data->accel1);
                return FALSE;
            }
        }
        if (data->accel2) {
...
_accel2_bound:
                g_set_error(error, LXKEYS_OB_ERROR, LXKEYS_FILE_ERROR,
                            _("Hotkey '%s' is already bound to an action."), data->accel2);
                return FALSE;
            }
        }
    }
    ...
    if (ll != NULL) {
        if (data->accel1 == NULL) {
            if (act->data1) fm_xml_file_item_destroy(act->data1);
            if (act->data2) fm_xml_file_item_destroy(act->data2);
            lxhotkey_action_free(act);
...
static gboolean obcfg_set_app_key(gpointer config, LXHotkeyApp *data, GError **error)
{
    ...
    for (ll = cfg->execs; ll; ll = ll->next) {
        if (g_strcmp0((app = ll->data)->exec, data->exec) == 0 && options_equal(app->options, data->options))
            break;
    }
...
_accel2_bound:
    ...
    if (ll != NULL) {
        if (data->accel1 == NULL) {
            if (app->data1) fm_xml_file_item_destroy(app->data1);
            if (app->data2) fm_xml_file_item_destroy(app->data2);
            lxhotkey_app_free(app);

...
#include <errno.h>
#include <ctype.h>
#include <glib.h> // Include GLib to inherit consistent cross-platform boolean variables
...
// Fallback path configurations only if system headers missed them
#ifndef PATH_MAX
    #ifdef _WIN32
...
extern gboolean DumpExifMap; // Aligned with jhead.c

#define MAX_DATE_COPIES 10

//--------------------------------------------------------------------------
// This structure stores Exif header image elements
typedef struct {
...
extern gboolean ShowTags; // Aligned with jhead.c

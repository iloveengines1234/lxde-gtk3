...
/* Core Library Infrastructure Control Hooks */
gboolean fm_init(FmConfig* config);

/* Fixed: Explicitly added void parameter mapping to avoid modern strict prototype warnings */
void fm_finalize(void);

const char *fm_version(void);

/* Shared execution data quark reference */
extern GQuark fm_qdata_id;

G_END_DECLS

#endif /* __LIBFM_FM_H__ */
namespace Fm {
	...
	public class Path {
		...
		public bool equal_str(string str, ssize_t n);
		public int depth();
	}
	...
	public class FileInfo {
		...
		/* Fixed: Primitive data wrappers must be passed by value without unowned modifiers */
		public Posix.time_t get_mtime();
		public Posix.time_t get_atime();

		public bool can_thumbnail();
	}

	/* Fixed: Reconfigured AppInfo from a Namespace to a compact CRef-linked Class layout descriptor */
	[Compact]
	[CCode (ref_function = "g_object_ref", unref_function = "g_object_unref", cname = "FmAppInfo", cprefix = "fm_app_info_", cheader_filename = "fm-app-info.h")]
	public class AppInfo : GLib.AppInfo {
		...
		public bool launch_default_for_uri(string uri, GLib.AppLaunchContext? launch_context = null) throws GLib.Error;
	...
	[CCode (cprefix = "fm_app_lookup_", cheader_filename = "fm-app-lookup.h")]
	namespace AppLookup {
		[CCode (cname = "fm_app_lookup_get_default_for_uri_scheme")]
		public static GLib.AppInfo? get_default_for_uri_scheme(string scheme);
	}
}
...
#define FM_IS_PATH_ENTRY(obj)         (G_TYPE_CHECK_INSTANCE_TYPE((obj), FM_TYPE_PATH_ENTRY))
#define FM_IS_PATH_ENTRY_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE((klass), FM_TYPE_PATH_ENTRY))

...
image_constructor(Plugin *p, char **fp)
{
    ...
    /* Modern visibility API */
    gtk_widget_set_visible(img->mainw, TRUE);
    ...
    /* Add the image widget to the event box */
    ...
    /* Replace deprecated border width with margins */
    gtk_widget_set_margin_start(img->mainw, 0);
    gtk_widget_set_margin_end(img->mainw, 0);
    gtk_widget_set_margin_top(img->mainw, 0);
    gtk_widget_set_margin_bottom(img->mainw, 0);

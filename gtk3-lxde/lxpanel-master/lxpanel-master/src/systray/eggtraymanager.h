...
#include <gtk/gtk.h> /* Cleaner to just include the core header */
...
/* Alias NaTrayManagerChild directly to GtkWidget so the signatures match reality */
typedef GtkWidget NaTrayManagerChild;

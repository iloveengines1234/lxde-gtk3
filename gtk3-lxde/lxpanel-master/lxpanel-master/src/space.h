...
/* Type macros */
#define PANEL_TYPE_SPACE \
    (panel_space_get_type())

#define PANEL_SPACE(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), PANEL_TYPE_SPACE, PanelSpace))

#define PANEL_IS_SPACE(obj) \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), PANEL_TYPE_SPACE))
...
/* GObject type getter */
GType panel_space_get_type(void) G_GNUC_CONST;

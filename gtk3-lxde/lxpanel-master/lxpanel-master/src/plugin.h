 ...
 * dialog will be destroyed on response or on instance destroy and any
 ...
 *
 * Returns: (transfer full): new created dialog widget.
 */
...
extern gboolean lxpanel_apply_hotkey(char **hkptr, const char *keystring,
                                     ...
                                     pointer user_data, gboolean show_error);
